...
export const ByTheNumbers = ({
  nps = {
    ...
    subtitle: '(Average for conferences: 32-44. A score above 40 is considered strong.)',
  },
  socialMedia = {
    reach: '1.2 M',
    impressions: '3.5 M',
  ...
  return (
    <section className="relative z-10 py-24 border-foreground">
      <div className="mx-auto max-w-7xl px-8 lg:px-12">
        {/* Section Title */}
        <BlurText
          segments={[{ text: 'By the Numbers' }]}
          delay={40}
          animateBy="words"
          direction="top"
        ...
        {/* NPS Card */}
        <div className="mb-12">
          <WigglyCard className="w-full">
            <div className="relative bg-gradient-to-br from-balance-500/90 to-transparent border border-balance-300/50 backdrop-blur-sm rounded-3xl p-12 md:p-16 text-center overflow-hidden">
              <LaurelWreath />
              <div className="relative z-10">
                <h3 className="text-7xl font-serif-display md:text-9xl font-bold text-accent-gold mb-4">
                  {nps.score}
                </h3>
                <p className="text-xl font-semibold md:text-4xl text-white font-medium mb-4">
                  {nps.label}
                </p>
                <p className="text-sm md:text-base text-balance-200">
                  {nps.subtitle}
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {/* Social Media Reach */}
          <WigglyCard>
            <div className="bg-gradient-to-br from-balance-500/90 to-transparent backdrop-blur-sm border border-balance-300/50 rounded-3xl p-8 h-full">
              <h3 className="text-2xl md:text-xl font-semibold text-white mb-8">
                Social Media Reach
              </h3>
              <div className="space-y-6">
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="text-2xl font-medium text-balance-200">Reach</span>
                </div>
                <div className="flex items-baseline justify-between">
                  <span className="text-3xl md:text-4xl font-bold text-white">
                    {socialMedia.impressions}
                  </span>
                  <span className="text-2xl font-medium text-balance-200">Impressions</span>
                </div>
                <div className="flex items-baseline justify-between">
                  <span className="text-3xl md:text-4xl font-bold text-white">
                    {socialMedia.linkClicks}
                  </span>
                  <span className="text-2xl font-medium text-balance-200">Link Clicks</span>
                </div>
              </div>
            </div>
          </WigglyCard>
            ...
            <div className="bg-gradient-to-br from-balance-500/90 to-transparent backdrop-blur-sm border border-balance-300/50 rounded-3xl p-8 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-baseline justify-between">
                  ...
                  <span className="text-2xl font-medium text-balance-200">Clicks</span>
                </div>
                <div className="flex items-baseline justify-between">
                  <span className="text-3xl md:text-4xl font-bold text-white">
                    {googleAds.ctr}
                  </span>
                  <span className="text-2xl font-medium text-balance-200">CTR</span>
                </div>
              </div>
            </div>
          </WigglyCard>
          ...
          <WigglyCard>
            <div className="bg-gradient-to-br from-balance-500/90 to-transparent backdrop-blur-sm border border-balance-300/50 rounded-3xl p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-baseline justify-between">
                  <span className="text-3xl md:text-4xl font-bold text-white">
                    {mediaCoverage.promoArticles}
                  </span>
                  <span className="text-2xl font-medium text-balance-200">
                    Promo Articles
                  </span>
                </div>
                <div className="flex items-baseline justify-between">
